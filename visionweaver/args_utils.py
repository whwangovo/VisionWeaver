...
class ModelArguments:
    ...
    tune_vision_adapter: bool = field(default=False)
    pretrain_mm_mlp_adapter: Optional[str] = field(default=None)
    # experts args
    clip_hr: bool = field(default=False)
    image_size: Optional[int] = field(default=336)
    ...
    mm_version: Optional[str] = field(default="std")
