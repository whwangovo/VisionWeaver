...
class ModelArguments:
    ...
    vision_expert_registry: Optional[dict] = field(default=None)
    base_vision_tower: Optional[str] = field(default=MISSING)
    vision_image_processor: Optional[str] = field(default=MISSING)
    convnext_hidden_size_map: Optional[dict] = field(default=None)
    convnext_num_attention_heads: Optional[int] = field(default=None)
    convnext_num_layers: Optional[int] = field(default=None)
    dino_num_patches: Optional[int] = field(default=None)
    pix2struct_hidden_size: Optional[int] = field(default=None)
    sam_hidden_size: Optional[int] = field(default=None)
    vary_hidden_size: Optional[int] = field(default=None)
